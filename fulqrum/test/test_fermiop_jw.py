...
def test_jwH2():
    ...
    terms = [
        ("+-", (0, 0), (-1.25633907300325 + 0j)),
        ("+-", (1, 1), (-0.471896007281142 + 0j)),
        ("+-", (2, 2), (-1.25633907300325 + 0j)),
        ("+-", (3, 3), (-0.471896007281142 + 0j)),
        ("++--", (0, 0, 0, 0), (0.3378550774017582 + 0j)),
        ("+-+-", (0, 0, 1, 1), (0.3322908651276483 + 0j)),
        ("+-+-", (0, 0, 2, 2), (0.3378550774017582 + 0j)),
        ("+-+-", (0, 0, 3, 3), (0.3322908651276483 + 0j)),
        ("++--", (0, 0, 1, 1), (0.09046559989211571 + 0j)),
        ("+-+-", (0, 0, 1, 1), (-0.09046559989211571 - 0j)),
        ("+-+-", (0, 1, 2, 3), (0.09046559989211571 + 0j)),
        ("+--+", (0, 1, 2, 3), (-0.09046559989211571 - 0j)),
        ("+-+-", (0, 0, 1, 1), (-0.09046559989211571 - 0j)),
        ("--++", (0, 0, 1, 1), (0.09046559989211571 + 0j)),
        ("-++-", (0, 1, 2, 3), (-0.09046559989211571 - 0j)),
        ("-+-+", (0, 1, 2, 3), (0.09046559989211571 + 0j)),
        ("+-+-", (0, 0, 1, 1), (0.3322908651276483 + 0j)),
        ("++--", (1, 1, 1, 1), (0.3492868613660083 + 0j)),
        ("+-+-", (1, 1, 2, 2), (0.3322908651276483 + 0j)),
        ("+-+-", (1, 1, 3, 3), (0.3492868613660083 + 0j)),
        ("+-+-", (0, 0, 2, 2), (0.3378550774017582 + 0j)),
        ("+-+-", (1, 1, 2, 2), (0.3322908651276483 + 0j)),
        ("++--", (2, 2, 2, 2), (0.3378550774017582 + 0j)),
        ("+-+-", (2, 2, 3, 3), (0.3322908651276483 + 0j)),
        ("+-+-", (0, 1, 2, 3), (0.09046559989211571 + 0j)),
        ("-++-", (0, 1, 2, 3), (-0.09046559989211571 - 0j)),
        ("++--", (2, 2, 3, 3), (0.09046559989211571 + 0j)),
        ("+-+-", (2, 2, 3, 3), (-0.09046559989211571 - 0j)),
        ("+--+", (0, 1, 2, 3), (-0.09046559989211571 - 0j)),
        ("-+-+", (0, 1, 2, 3), (0.09046559989211571 + 0j)),
        ("+-+-", (2, 2, 3, 3), (-0.09046559989211571 - 0j)),
        ...
        ("+-+-", (1, 1, 3, 3), (0.3492868613660083 + 0j)),
        ("+-+-", (2, 2, 3, 3), (0.3322908651276483 + 0j)),
        ("++--", (3, 3, 3, 3), (0.3492868613660083 + 0j)),
    ]
    fop = FermionicOperator(4, terms)
    op = fop.extended_jw_transformation()
    op_mat = sp.csr_array(qubitoperator_to_matrix(op))
